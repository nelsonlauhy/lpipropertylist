...
<head>
    ...
    <style>
        ...
        #searchButton {
            ...
            margin-right: 15px; /* Spacing between icon and search box */
...
<body>
    <div class="fixed-top bg-white border-bottom">
        <div class="container">
            <div class="row py-3 align-items-center"> <!-- Align items center for vertical alignment -->
                <div class="col-sm-1">
                    <span class="back-icon" onclick="window.location.href='index.html'">&lt;</span> <!-- Text-based arrow -->
                </div>
                <div class="col-sm-7">
